...
// MARK: - CountryTableViewCell implementation
...
// MARK: - CountryTableViewCell configuring

extension CountryTableViewCell {
    func configure(with contract: CountryTableViewCellContract) {
        contract.checked ? setCheckedState() : setUncheckedState()
        countryTitleLabel.text = contract.title
    }
}

// MARK: - CountryTableViewCell private methods
